...
!   */
    ...
    const getGruposAmbiente = async (ambiente) => {
        ...
        DlpController.getGruposDLP(payload)
            .then((response) => {
                let gruposAmbiente = response.data.split(',')
                            ...
                            DlpController.getCrudCfg(payload)
                                ...
                                .then((response) => {
                                    ...
                                    DlpController.postGrupoDLP(payloadPostGroup)
                                        .then((response) => {
                                            // alert(`As alterações do grupo ${item} foram atualizadas no BD do ambiente ${ambiente} com sucesso!`)
                                        })
                                        .catch((e) => {
                                            console.log(`Não foi possível salvar as alterações do grupo ${item} no BD do ambiente ${ambiente}.`)
                                        });
                                })
                                .catch((e) => {
                                    alert("Error")
                                                    ...
                                                    DlpController.getCrudCfg(payload)
                                                        ...
                                                        .then((response) => {
                                                            ...
                                                            DlpController.postGrupoDLP(payloadPostGroup)
                                                                ...
                                                                .catch((e) => {
                                                                    alert(`Não foi possível salvar as alterações do grupo ${item} no BD do ambiente ${ambiente}.`)
                                                                });
                                                        })
                                                        .catch((e) => {
                                                            alert("Error")
    ...
    const checaGrupoDlpDuplicado = async () => {
        ...
        const processarGrupo = async (item, index) => {
            try {
                ...
                //console.log(item);
                //console.log(jsonVars2Decoded[0]['Conteúdo Sugerido']);
                //console.log(jsonVars2Decoded[0]['Conteúdo Sugerido'] == item);
