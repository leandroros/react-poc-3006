...
const PalavrasSensiveisTable = () => {
    ...
    const getTemplate = () => {
        const templateUrl = process.env.PUBLIC_URL + '/templatePalavrasSensiveis.xlsx';
    ...
    const onFileUpload = () => {
        ...
        axios.post("http://localhost:3003/api/uploadfile", formData, {
          headers: {
...
{/*                         <button className="table-botoes-salvar" onClick={() => setIsModalUpoadTempate(true)}>Upload Palavras Sensíveis</button>
 */}
            ...
            <div className='table-botoes'>
                ...
                <button className='table-botoes-salvar' onClick={() => setIsModalSave(true)}>Salvar</button>
            ...
            {isModalUploadTemplate && (
                <div className="modal-container">
                    ...
                    <div className="modal-find-opcoes-tabela atualizar-pesquisa">
                            ...
                            <div>
{/*                                 <form action="/flashsafe/conf/form-Elements/teste" method="post" enctype="multipart/form-data">
 */}                                <form onSubmit={uploadArchive}>
                                    <input className="input-file" type="file" name="image" id="image" onChange={e => setImage(e.target.files[0])} />
                                    <button type='submit' className="table-botoes-salvar" onClick={() => { onFileUpload() }}>Enviar</button>
                                </form>
                            </div>
